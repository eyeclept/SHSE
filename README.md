...
- A running OpenSearch instance (2.x recommended)
...
| Reindex this target | Delete and rebuild the OpenSearch index for a single target |
| Reindex all | Wipe the entire OpenSearch index and rebuild from scratch |
...
| System health | Live connectivity status for OpenSearch, Nutch, Ollama, Redis |
